...
<body>
    ...
    <div class="py-5">
        <h1 class="display-4 fw-bolder">Agregar Publicación</h1>
        <div class="main-agileinfo">
            <div class="agileits-top">
                <form action=<?php echo "../Controlers/controlAddProduct.php?data=".$idUser?> method="POST">
                    <input id="titleProduct" name="titleProduct" placeholder="Titulo" type="text" class="btn btn-outline-dark mt-auto" required="">
                    <input id="priceProduct" name="priceProduct" placeholder="Precio" type="number" step="0.01" min="1" class="btn btn-outline-dark mt-auto" required="">
