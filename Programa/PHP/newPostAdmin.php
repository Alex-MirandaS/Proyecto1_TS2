...
$products = selectProductService_status($conection, 0);
$user = $user[0];
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder"> Nuevas Publicaciones
                </h1>
            </div>
        </div>
    </header>
...
<?php 
               ...
               <div class=\"card h-100\">
                   ...
                   <div class=\"card-footer p-4 pt-0 border-top-0 bg-transparent\">
                       <div class=\"text-center\"><a id=\"productPageButton\" class=\"btn btn-outline-dark mt-auto\" href=\"../Controlers/controlStatusCatalogues.php?data1=".$idUser."&data2=".$post->getIdProductServiceVol()."&data3=".true."\">Aprobar</a></div>
                       <div class=\"text-center\"><a id=\"productPageButton\" class=\"btn btn-outline-dark mt-auto\" href=\"../Controlers/controlStatusCatalogues.php?data1=".$idUser."&data2=".$post->getIdProductServiceVol()."&data3=3\">Rechazar</a></div>
                   </div>
               </div>
           </div>";
                }
