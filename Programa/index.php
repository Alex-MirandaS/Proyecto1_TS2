...
$products = selectProductService_status($conection, 1);
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <h8 class="navbar-brand">G-SWAP</h8>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a id="addProduct" class="nav-link active" aria-current="page" href="PHP/register.php">Crear cuenta nueva</a></li>
                    <li class="nav-item"><a id="perfil" class="nav-link" href="PHP/login.php">Iniciar Sesion</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Todo al alcance de un click</h1>
            </div>
        </div>
    </header>
    <section class="py-5">
